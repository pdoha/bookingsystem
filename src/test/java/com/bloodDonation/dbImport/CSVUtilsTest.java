...
public class CSVUtilsTest {
    ...
    void test2(){
        ...
        List<String> sqlData = csvUtils.makeSql("data/centerInfo.csv", "CENTER_INFO", fields, "\'우편번호\', \'나머지주소\', \'운영시간\', \'예약요일\', \'예약가능시간\', \'예약불가시간\', 1, 50, 50", "EUC-KR").toList();
    ...
    void test3(){
        ...
        String[] fields = {"cCode", "location", "cName", "centerType", "address", "telNum", "zonecode", "addressSub", "operHour", "bookYoil", "bookAvl", "bookNotAvl", "bookHday", "bookBlock", "bookCapacity"};
        csvUtils.makeSql("data/centerInfo.csv", "CENTER_INFO", fields, "\'우편번호\', \'나머지주소\', \'운영시간\', \'예약요일\', \'예약가능시간\', \'예약불가시간\', 1, 50, 50", "EUC-KR").toFile(destPath);
